...
$('.loading').hide();
 ...
 $.each(movies, function(index, movie) {
  ...
  if (movie.ratings.audience_score == "0"){
   ...
   $('.movielist').append('<li><div class="postercolumn"><img src="' + movie.posters.detailed + '" width="180" height="261"/><div class="blueer"><a href="http://www.youtube.com/embed?listType=search&list=' + movie.title + ' trailer" target="_blank"><span class="icon" aria-hidden="true" data-icon="&#9654;"></span>   trailer</a></div><a href="http://www.google.com/movies?hl=en&q=' + movie.title + '" target="_blank"><span class="icon" aria-hidden="true" data-icon="&#128340;"></span>   showtimes</a></div><div class="infocolumn"><div class="titlebox"><h2>' + movTitle + '</h2></div><div class="reviewbox"><p>' + movie.synopsis + '</p><h6> ' + movie.release_dates.theater + ' &#183; ' + movie.runtime + ' min &#183; Rated ' + movie.mpaa_rating + '</h6></div><div class="scores"><div class="'+ noSpaceMovTitle +'Critic criticbox"><a href="' + movie.links.alternate + '#contentReviews"><h3>' + movie.ratings.critics_score + '</h3><p>CRITICS</p></a></div><div class="'+ noSpaceMovTitle +'Audience audiencebox"><a href="' + movie.links.alternate + '#audience_reviews"><h3>' + movie.ratings.audience_score + '</h3><p>AUDIENCE</p></a></div></div></div></li>');
